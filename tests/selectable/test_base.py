...
class ModelLookupTestCase(BaseSelectableTestCase):
    ...
    def test_get_name(self):
        ...
        self.assertEqual(name, 'selectable-simplemodellookup')

    def test_get_url(self):
        url = self.__class__.lookup_cls.url()
        test_url = reverse('selectable-lookup', args=['selectable-simplemodellookup'])
...
class MultiFieldLookupTestCase(ModelLookupTestCase):
    ...
    def test_get_name(self):
        name = self.__class__.lookup_cls.name()
        self.assertEqual(name, 'selectable-multifieldlookup')

    def test_get_url(self):
        url = self.__class__.lookup_cls.url()
        test_url = reverse('selectable-lookup', args=['selectable-multifieldlookup'])
        self.assertEqual(url, test_url)
