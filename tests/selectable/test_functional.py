...
from selectabletest.models import ManyThing, OtherThing, ThingLookup
...
class FuncAutoCompleteSelectTestCase(BaseSelectableTestCase):
    ...
    def test_invalid_but_still_selected(self):
        ...
        self.assertEqual(thing_0.attrs['value'], self.test_thing.name)
        # Selected pk should be populated
        thing_1 = inputs['thing_1'][0]
        self.assertEqual(int(thing_1.attrs['value']), self.test_thing.pk)
