...
class SelectableMediaMixin(object):
    ...
    class Media(object):
        css = {
            'all': ('{}css/dj.selectable.css'.format(STATIC_PREFIX), '{}css/jquery-ui.css'.format(STATIC_PREFIX))
        }
        js = ['{}js/{}.js'.format(STATIC_PREFIX, m) for m in ['jquery-1.10.2.min', 'jquery-ui', 'jquery.dj.selectable']]
