!function () {
    ...
    a.modules = {}, a.aliases = {}, a.resolve = function (b) {
        ...
        !function (a, d) {
            "use strict";
            var e = a.document, f = b("get-by-class"), g = b("extend"), h = b("indexof"), i = function (a, c, i) {
                var j, k = this, l = b("./src/item")(k), m = b("./src/add-async")(k), n = b("./src/parse")(k);
                j = {
                    start: function () {
                        k.listClass = "list", k.searchClass = "search", k.sortClass = "sort", k.page = 200, k.i = 1, k.items = [], k.visibleItems = [], k.matchingItems = [], k.searched = !1, k.filtered = !1, k.handlers = {updated: []}, k.plugins = {}, k.helpers = {
                            getByClass: f,
                            extend: g,
                            indexOf: h
        ...
        c.exports = function (a) {
            var b, c, g, h, i = {
                ...
                list: function () {
                    ...
                    a.found = !1;
                    for (var b = 0, d = c.length; d > b; b++)if (j.values(a.values(), c[b]))return a.found = !0, void 0
                }, values: function (a, c) {
        ...
        var d = b("natural-sort"), e = b("classes"), f = b("events"), g = b("get-by-class"), h = b("get-attribute");
        c.exports = function (a) {
...
(function ($) {
    ...
    init_list_filter = function () {
        ...
        app_list = new List('apps', options);
        app_list.on('searchComplete', function () {
            if (!app_list.searched) {
                $(app_list.listContainer).removeClass('showing-search-results');
                return false;
            }
            $(app_list.listContainer).addClass('showing-search-results');
        });
    }
    ...
    disable_default_filter = function () {
        $search = $('.search-apps-models .search');
        $search.val('');
        app_list.search();
        clone = $search.clone();
        $search.remove();
        $('.search-apps-models .wrapper').append(clone);
    }
    $('.search-in-model').on('click', function () {
        $('.search-apps-models form').prop('action', $(this).data('url-model-name'));
        $('.search-apps-models .remove-this .text').text($(this).data('model-name'));
        $('.search-apps-models .remove-this').show(100);
        disable_default_filter();
        $('.search-apps-models .search').focus();
        return false;
    });

    $('.search-apps-models .remove-this').on('click', function () {
        $('.search-apps-models').prop('action', '');
        $(this).hide(100);
        init_list_filter();
    });

    $('.actions .btn').tooltip({'container': 'body'});
})(django.jQuery);
